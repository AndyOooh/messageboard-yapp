...
export const YAPP_URL = process.env.NODE_ENV === "development" ? "http://localhost:3000" : "https://messageboard-yapp.vercel.app/";
export const YAPP_ENS_NAME = "messageboard-yapp.yodl.eth";
export const PARENT_URL =
  process.env.NODE_ENV === "development" ? "http://localhost:3001" : "https://dapp-git-sb-add-user-context-request-yodl.vercel.app/";
